...
export class IntensiveCareComponent {
  ...
  showSpecialty(value: any, order: number) {
    if (value === 'Burn Unit') {
      ...
      if (order === 1) {
        this.options = ['Congenital', 'IVAR', 'PCI', 'Others'];
      } else {
        this.secondaryOptions = ['Congenital', 'IVAR', 'PCI', 'Others'];
      }
      ...
      value === 'Neurosurgery, Neuroradiology and Neuro Critical Care'
    ) {
      if (order === 1) {
        this.options = [
          'Craniotomy',
      ...
      if (order === 1) {
        this.options = ['Sedation', 'GA', 'Others'];
      } else {
        this.secondaryOptions = ['Sedation', 'GA', 'Others'];
      }
  ...
  showSupportTypeCategories(supportType: string) {
    if (supportType === 'Airway Support') {
      ...
      this.supportCategories = ['No assistance', 'NIMV', 'HFJV', 'IMV', 'ECMO'];
      ...
      this.supportCategories = ['MARS', 'Prometheus'];
      ...
      this.supportCategories = ['Plasmapheresis'];
    }
  }
}
